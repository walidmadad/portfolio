        ...
        <nav className="bg-gradient-to-br from-purple-950 via-purple-900 to-purple-950 text-white p-4 shadow-lg fixed w-full z-10 transition-all duration-300 ease-in-out">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="flex items-center">
                    <a href="#" className="flex items-center transition duration-300 hover:opacity-80" aria-label="Home">
                        ...
                        <span className="text-lg font-bold">Walid Madad</span>
                    </a>
                </div>

                {/* Desktop Navigation */}
                <div className="hidden md:flex space-x-8">
                    {['About', 'Technologies', 'Projects', 'Android Games', 'Contact'].map((link) => (
                        <a
            ...
            {isOpen && (
                <div className="md:hidden flex flex-col space-y-2 mt-2 p-4 bg-gray-700 rounded-lg shadow-lg transition-all duration-300 ease-in-out">
                    {['About', 'Technologies', 'Android Games', 'Projects', 'Contact'].map((link) => (
                        <a
                            href={`#${link.toLowerCase()}`}
                            key={link}
